...
<form class="" action="{{ route('vacantes.buscar')}}" method="post">
  @csrf
  <div class="mb-5">
  ...
  <button type="submit" class="bg-teal-500 w-full hover:bg-teal-600 text-gray-100 font-bold p-3 focus:outline-none focus:shadow-outline uppercase mt-10" name="button">Burcar Vacantes</button>
